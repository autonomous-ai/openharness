 ...
 * `harness-list` for `Fix the harness list order`, or `login` for `Fix the login page` (`login-page`
 * if `login` is taken), when the session first has a name. A name still taken gets `-2`, `-3`… Only a branch Harness
