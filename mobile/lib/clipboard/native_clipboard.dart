...
class NativeClipboard {
  ...
  ///
  /// EMPTY bytes (iOS) mean an image IS on the clipboard but could not be read or re-encoded, so a
  /// caller can say "unreadable" rather than "nothing there". Every other call site already treats
  /// empty as "no image".
  ///
