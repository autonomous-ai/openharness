// Run the Models tests with --coverage, then check the feature's four modules.
...
console.log(`Models desktop: ${covered}/${total} lines (100%) across four feature modules.`)
