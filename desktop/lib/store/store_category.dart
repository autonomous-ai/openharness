...
class StoreCategory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final discipline = storeDiscipline(path?.categories.first ?? name);
    final example = path == null
        ? discipline.example(entries)
        : storeCollectionExample(path, entries);
              ...
              child: Column(
                ...
                children: [
                  _DisciplineHero(
                    ...
                    entry: example,
                    headline: path?.title ?? discipline.headline,
                    description: path?.subtitle ?? discipline.description,
