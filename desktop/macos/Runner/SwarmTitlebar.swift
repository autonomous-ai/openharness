...
final class SwarmTitlebar: NSObject, NSMenuItemValidation, NSMenuDelegate {
  ...
  private func sendTabAction(_ method: String, arguments: Any?) {
    guard ["select", "close", "new", "rename", "commands", "notifications", "store", "addAgent", "newAgent", "newTerminal", "runLocalModel", "splitRight", "splitDown", "zoomPane", "pinPane", "machineDestination", "machineAgent", "manageMachines"].contains(method) else {
