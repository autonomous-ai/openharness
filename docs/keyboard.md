...
Session results use one line each, with the name and activity age. The preview shows the machine, project, and branch directly beneath the session name; these fields remain searchable.
